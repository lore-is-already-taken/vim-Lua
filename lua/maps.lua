...
-- #### atajos del editor o sea yo, el Lore hehehe
...
vim.keymap.set('n', '<leader>s', '<Plug>(easymotion-s2)', { desc = 'Search for 2 letters' })



-- #### Terminan los atajos del lore c:
